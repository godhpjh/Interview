...
또다른 단점은 급박한 상황속 같은 임기응변에 대해 약하다는 것이 단점입니다.
급박한 상황속에서 결정을 하고 판단을 해야 할 경우에 쉽게 결정을 내리지 못하거나 판단을 하지
못하여 생기는 일이 있을 수 있다는 것이 저의 단점입니다.

# 마지막 할말
- KT그룹의 IT 솔루션을 책임지고 운영할 수 있는 최선을 다하는 개발자가 되고 싶습니다.


# ktds 입사후포부
- kt ds에서 운영하고 있는 어떠한 분야를 맡야 전반적인 프로세스를 이해하고 운영해 보고 싶습니다.
...
운영건에 대해서 자동화를 개발하여 더 나은 서비스를 제공해보고 싶습니다.

# ktds 지원동기
- KT DS는 KT그룹의 IT솔루션에 대해서 관리하고 운영하는 핵심회사로 알고 있습니다.
통신 사업 뿐만 아니라 금융이나 유통 등 다양한 산업분야로 확장해 나가면서 성장하고 있는 모습을 보았습니다. 최근 용산에 IDC 데이터센터를 구축하고 가동하는 뉴스 기사를 보게 되었습니다.
대규모의 IDC 데이터센터를 보유하고 있고 그에 대해 클라우드 및 인프라적인 요소를 확장하게 되면서 회사에 대한 성장가능성과 비전을 보게 되어서 저 또한 그러한 대용량 데이터를 접해 볼 수 있고 전반적인 운영 업무를 다뤄볼 수 있는 최적의 입지라 생각하게 되었고 저 또한 성장할 수 있는 기회라 생각하여 지원하게 되었습니다.

금융 사업실적 - K뱅크 차세대 구축
유통 사업실적 - kt commerce, kt mhows 차세대 프로젝트 구축
에너지    - GiGa 에너지 차세대 개발
가즈아
